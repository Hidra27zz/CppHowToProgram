...
int main() {
    // use the default radom-number generation engine to produce uniformly distributed pseudorandom int values from 10 to 99
    ...
    // get input from user
    cout << "\nPlease enter an integer value (-1 to quite:) ";
