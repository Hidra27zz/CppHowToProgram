...
// compare key to every element of array until location is found or until end of array is reached; return location of element if key is found or -1 if key is not found
